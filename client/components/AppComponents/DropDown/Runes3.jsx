  ...
  return (
    <div className="TreeDiv" id="runes3">
      ...
      <div className="minorShardRow">
        ...
        <img className="inactiveRune" id={`${matchNum}-r2-5003`} src="https://raw.communitydragon.org/latest/plugins/rcp-be-lol-game-data/global/default/v1/perk-images/statmods/statmodsmagicresicon.magicresist_fix.png"/>
      </div>
      ...
      <div className="minorShardRow">
        ...
        <img className="inactiveRune" id={`${matchNum}-r3-5003`} src="https://raw.communitydragon.org/latest/plugins/rcp-be-lol-game-data/global/default/v1/perk-images/statmods/statmodsmagicresicon.magicresist_fix.png"/>
      </div>
