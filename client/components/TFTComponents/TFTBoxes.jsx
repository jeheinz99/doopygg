...
import TFTDropDownBox from './TFTDropDownBox';
  ...
  return (
    <div className="TFTWrapper">
      <div className="TFTMatches" id={id}>
        ...
        <button id="DropDownButton" onClick={() => setOpen(!tftOpen) }><img src={'https://upload.wikimedia.org/wikipedia/commons/d/db/Vector_down_arrow_link.svg'}/></button>
        </div>
      </div>
